...
import forparents from './for-parents.webp'
import forteachers from './for-teachers.webp'
        ...
        <div className='Component3_main'>
            <div className='Component3_wrap'>
                <div className="Component3_A">
                    <img className='Component3_image' src={forparents} />
                ...
                <div className="Component3_B">
                    <img className='Component3_image' src={forteachers} />
